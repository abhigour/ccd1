...
public class NethraAppController extends Controller {
    ...
    final static String USER_PASS = "ccd123:DMfK74O8Euy2kZOL";
...
//    final static String collectionRows =  "{\n" +  // This is first set of Demo Data.. Would not be required later. 
//			"  \"patientId\": {\"xyz\"}" +
//			"  \"visits\": [\n" + 
//			"    {\n" + 
//			"      \"doctor_name\": \"doctor1\",\n" + 
...
//			"}";
    ...
    public void fetchRecentAppointment() {
    	//String response = collectionRows;
    	try {
    		Document discussionDocument = getDatabase(DBNAME).getCollection(DISCUSSIONS_TABLE).findOneAndDelete(null);
//    		try {
//    		    while (discussionDocument.hasNext()) {
//    		        //System.out.println(discussionDocument.next().toJson());
//    		    }
//    		} finally {
//    			discussionDocument.close();
//    		}
